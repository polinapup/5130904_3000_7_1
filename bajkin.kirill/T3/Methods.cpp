...
double getAreaEvenOdd(double curr, const bajkin::Polygon& pol, bool even)
{
...
double getAreaMean(double curr, const bajkin::Polygon& pol)
{
  curr += pol.getArea();
  return curr;
}

double getNVertex(double curr, const bajkin::Polygon& pol, size_t count)
{
...
void bajkin::getArea(std::istream& in, std::ostream& out, const std::vector< Polygon >& pol)
{
  std::string name = "";
  in >> name;
  double sum = 0;
...
size_t getVertex(const bajkin::Polygon& pol)
{
  return pol.points.size();
}

void bajkin::getMinMax(std::istream& in, std::ostream& out, const std::vector< Polygon >& pol, bool min)
{
  if (pol.empty())
  {
    throw std::logic_error("<INVALID COMMAND>");
...
bool isEven(const bajkin::Polygon& pol, bool even)
{
  return even == (pol.points.size() % 2 == 0);
}

bool isCorrectCountAngle(const bajkin::Polygon& pol, size_t countVertex)
{
  return countVertex == pol.points.size();
}

void bajkin::count(std::istream& in, std::ostream& out, const std::vector< Polygon >& pol)
{
  std::string name = "";
  in >> name;
...
bool less(const bajkin::Polygon& p1, const bajkin::Polygon& p2)
{
  return getAreaMean(0, p1) < getAreaMean(0, p2);
}

void bajkin::lessArea(std::istream& in, std::ostream& out, const std::vector< Polygon >& pol)
{
  Polygon p;
  in >> p;
  if (!in || in.peek() != '\n')
...
bool interPred(const bajkin::Polygon& p1, const bajkin::Polygon& p2)
{
...
void bajkin::intersections(std::istream& in, std::ostream& out, const std::vector< Polygon >& pol)
{
  Polygon p;
  in >> p;
  if (!in || in.peek() != '\n')
